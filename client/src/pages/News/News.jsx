...
export default function MediaCard() {
  ...
  //   };
  useEffect(() => {
    axios(link + '/api/post/getall').then(e => {
      if (e.data.data.length > 0) {
        setState(e.data.data.slice(olds, newS))
        setIsload(true)
      }
  ...
  return (
    <div className='now conter'>
      <div className="load">
        <div className="news">
          <h2>2023- yil - Inson qadrini ulug'lash va faol mahalla yili</h2>
